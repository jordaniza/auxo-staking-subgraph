(module
  ...
  (func $start:tests/tokenLocker.test~anonymous|0~anonymous|0 (type 5)
    (local i32 i32 i32 i64)
    global.get $tests/tokenLocker.test/MOCK_ADDRESS
    i32.const 5616
    i32.const 5664
    ...
    i32.load offset=4
    drop
    global.get $tests/tokenLocker.test/ARV_ADDRESS
    ...
    local.get 0
    call $~lib/matchstick-as/index/MockedFunction#returns)
  (func $start:tests/tokenLocker.test~anonymous|0~anonymous|1 (type 5)
    call $~lib/matchstick-as/assembly/store/clearStore)
  (func $tests/tokenLocker.test/NumContainer#constructor (type 0) (param i32) (result i32)
    (local i32)
    i32.const 8
    i32.const 22
    call $~lib/rt/stub/__new
  ...
  (func $~lib/array/Array<~lib/@graphprotocol/graph-ts/chain/ethereum/ethereum.EventParam>#push (type 1) (param i32 i32)
    ...
    local.get 11
    i32.store offset=12)
  (func $tests/tokenLocker.helpers/createDepositedEvent (type 4) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i64)
  ...
  (func $start:tests/tokenLocker.test~anonymous|0~anonymous|2 (type 5)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64)
    i32.const 100
    call $tests/tokenLocker.test/NumContainer#constructor
    local.set 9
    i32.const 50
    call $tests/tokenLocker.test/NumContainer#constructor
    local.set 3
    ...
    local.get 11
    local.get 6
    call $tests/tokenLocker.helpers/createDepositedEvent
    local.set 13
    local.get 3
    i32.load offset=4
    local.set 5
  ...
  (func $start:tests/tokenLocker.test~anonymous|0~anonymous|3 (type 5)
    ...
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.bigIntToString
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $start:tests/tokenLocker.test~anonymous|0 (type 5)
    i32.const 6864
    i32.load
    i32.const 6896
  ...
  (func $~start (type 5)
    ...
    i32.const 5264
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.stringToH160
    global.set $tests/tokenLocker.test/MOCK_ADDRESS
    i32.const 5376
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.stringToH160
    global.set $tests/tokenLocker.test/ARV_ADDRESS
    i32.const 5488
    i32.const 18640
    i32.load
  ...
  (global $tests/tokenLocker.test/MOCK_ADDRESS (mut i32) (i32.const 0))
  (global $tests/tokenLocker.test/ARV_ADDRESS (mut i32) (i32.const 0))
  ...
  (elem $0 (i32.const 1) func $start:tests/tokenLocker.test~anonymous|0~anonymous|0 $start:tests/tokenLocker.test~anonymous|0~anonymous|1 $~lib/@graphprotocol/graph-ts/common/value/Value#displayData~anonymous|0 $start:tests/tokenLocker.test~anonymous|0~anonymous|2 $start:tests/tokenLocker.test~anonymous|0~anonymous|3 $start:tests/tokenLocker.test~anonymous|0)
